<template>
  <div>
    <CCard>
      ...
      <CCardFooter>
        <CButton class="mr-2" type="submit" size="sm" color="info" @click="handleAddAdmin">Register</CButton>
        <CButton class="mr-2" type="submit" size="sm" color="primary" @click="$router.go(-1)">Kembali</CButton>
      </CCardFooter>
    </CCard>
  </div>
</template>
